...
2. **Automation stack** – code lives under `src/browser/`:
   ...
   - Navigates to `chatgpt.com`, switches the model to the requested GPT-5.5 / GPT-5.4 / GPT-5.2 variant, pastes the prompt, waits for completion, and copies the markdown via the built-in copy action.
